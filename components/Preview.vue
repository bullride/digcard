<template>
  <div
    class="overflow-y-scroll max-hd border-t-0 border-4 border-black bg-gray-bg">
    <div id="Theme1">
      <html
        ref="html"
        lang="en"
      ...
      >
        ...
        <body id="body">
          ...
          <header style="padding:0;height:250px;">
            <img
              id="logo"
              v-if="images.logo.url"
              :src="PreviewMode ? images.logo.url : `./logo.${images.logo.ext}`"
              alt="Logo" class="headlogoo" style="object-fit: cover !important;width: 100%;min-height: 250px;max-height: 250px;padding:0;box-shadow: 0px 3px 15px 0px rgb(101 101 101), 0 7px 10px -5px rgb(0 0 0 / 15%);"
            />
            <div
              id="topActions"
